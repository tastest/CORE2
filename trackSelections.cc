...
std::pair<double, double> trks_d0_pv (int itrk, int ipv, bool useDAvtxs)
{
    // assume the layout of the covariance matrix is (Vxx, Vxy, Vxz)
    //						      (Vyx, Vyy, ...)
    const double bx  = useDAvtxs ? cms2.davtxs_position().at(ipv).x()    : cms2.vtxs_position().at(ipv).x()   ;
    const double by  = useDAvtxs ? cms2.davtxs_position().at(ipv).y()    : cms2.vtxs_position().at(ipv).y()   ;
    const double vxx = useDAvtxs ? cms2.davtxs_covMatrix().at(ipv).at(0) : cms2.vtxs_covMatrix().at(ipv).at(0);
    const double vxy = useDAvtxs ? cms2.davtxs_covMatrix().at(ipv).at(1) : cms2.vtxs_covMatrix().at(ipv).at(1);
    const double vyy = useDAvtxs ? cms2.davtxs_covMatrix().at(ipv).at(4) : cms2.vtxs_covMatrix().at(ipv).at(4);
...
std::pair<double , double> gsftrks_d0_pv (int itrk, int ipv, bool useDAvtxs)
{
    // assume the layout of the covariance matrix is (Vxx, Vxy, Vxz)
    //						      (Vyx, Vyy, ...)
    const double bx  = useDAvtxs ? cms2.davtxs_position().at(ipv).x()    : cms2.vtxs_position().at(ipv).x()   ;
...
std::pair<double, double> trks_dz_pv (int itrk, int ipv, bool useDAvtxs)
{
    LorentzVector pv = useDAvtxs ? cms2.davtxs_position().at(ipv) : cms2.vtxs_position().at(ipv);
    double pvxErr    = useDAvtxs ? cms2.davtxs_xError().at(ipv)   : cms2.vtxs_xError().at(ipv)  ;
    double pvyErr    = useDAvtxs ? cms2.davtxs_yError().at(ipv)   : cms2.vtxs_yError().at(ipv)  ;
    double pvzErr    = useDAvtxs ? cms2.davtxs_zError().at(ipv)   : cms2.vtxs_zError().at(ipv)  ;
...
std::pair<double, double> gsftrks_dz_pv (int itrk, int ipv, bool useDAvtxs)
{
    LorentzVector pv = useDAvtxs ? cms2.davtxs_position().at(ipv) : cms2.vtxs_position().at(ipv);
    double pvxErr    = useDAvtxs ? cms2.davtxs_xError().at(ipv)   : cms2.vtxs_xError().at(ipv)  ;
    double pvyErr    = useDAvtxs ? cms2.davtxs_yError().at(ipv)   : cms2.vtxs_yError().at(ipv)  ;
