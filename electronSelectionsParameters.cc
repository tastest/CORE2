...
void eidGetVBTF(const vbtf_tightness tightness, std::vector<double> &cutdeta, std::vector<double> &cutdphi, std::vector<double> &cuthoe, std::vector<double> &cutsee, std::vector<double> &cutreliso)
{
    ...
    switch (tightness) {
        ...
        case VBTF_TOP90:
            {
                double isoThresholds_tmp[2]                 = {0.2,     0.15};   
                double sigmaIEtaIEtaThresholds_tmp[2]       = {0.01,    0.03};
                double dPhiInThresholds_tmp[2]              = {0.09,     0.7};
                double dEtaInThresholds_tmp[2]              = {0.008,   0.008};
                double hoeThresholds_tmp[2]                 = {0.06,     0.03};
                eidAssign(cutreliso, isoThresholds_tmp, 2);
                eidAssign(cutdeta, dEtaInThresholds_tmp, 2);
                eidAssign(cutdphi, dPhiInThresholds_tmp, 2);
                eidAssign(cuthoe, hoeThresholds_tmp, 2);
        ...
        case VBTF_TOP85:
            {   
                double isoThresholds_tmp[2]                 = {0.15,     0.12};
                double sigmaIEtaIEtaThresholds_tmp[2]       = {0.01,    0.03};        
        ...
        case VBTF_TOP80:
            {   
                double isoThresholds_tmp[2]                 = {0.12,     0.09};
                double sigmaIEtaIEtaThresholds_tmp[2]       = {0.01,    0.03};
                double dPhiInThresholds_tmp[2]              = {0.04,     0.025};       
                double dEtaInThresholds_tmp[2]              = {0.008,   0.006};
                double hoeThresholds_tmp[2]                 = {0.04,     0.025};
                eidAssign(cutreliso, isoThresholds_tmp, 2);
                eidAssign(cutdeta, dEtaInThresholds_tmp, 2);
                eidAssign(cutdphi, dPhiInThresholds_tmp, 2);
        ...
        case VBTF_TOP70:
            {   
                double isoThresholds_tmp[2]                 = {0.08,     0.04};
                double sigmaIEtaIEtaThresholds_tmp[2]       = {0.01,    0.03};                
                double dPhiInThresholds_tmp[2]              = {0.04,     0.025};       
                double dEtaInThresholds_tmp[2]              = {0.004,   0.004};
                double hoeThresholds_tmp[2]                 = {0.04,     0.025};
                eidAssign(cutreliso, isoThresholds_tmp, 2);
                eidAssign(cutdeta, dEtaInThresholds_tmp, 2);
                eidAssign(cutdphi, dPhiInThresholds_tmp, 2);
        ...
        case VBTF_TOP55:
            {
                double isoThresholds_tmp[2]                 = {0.06,     0.04};
                double sigmaIEtaIEtaThresholds_tmp[2]       = {0.01,    0.025};
                double dPhiInThresholds_tmp[2]              = {0.02,     0.025};
                double dEtaInThresholds_tmp[2]              = {0.004,   0.002};
                double hoeThresholds_tmp[2]                 = {0.04,     0.007};
                eidAssign(cutreliso, isoThresholds_tmp, 2);
                eidAssign(cutdeta, dEtaInThresholds_tmp, 2);
                eidAssign(cutdphi, dPhiInThresholds_tmp, 2);
                eidAssign(cuthoe, hoeThresholds_tmp, 2);
